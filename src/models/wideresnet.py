"""
Wide ResNet implementation for CIFAR-10/100.
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, out_planes, stride, dropout_rate=0.0):
        ...
        self.shortcut = (not self.equal_inout) and nn.Conv2d(
...
class WideResNet(nn.Module):
    ...
    Args:
        depth: Total number of layers (should be 6n+4, e.g., 28)
        widen_factor: Width multiplier (e.g., 2, 8, 10)
        num_classes: Number of output classes
        dropout_rate: Dropout rate
    """
    
    def __init__(self, depth=28, widen_factor=2, num_classes=10, dropout_rate=0.0):
