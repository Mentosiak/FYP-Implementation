"""
Semi-Supervised Learning training script using Pseudo-Label algorithm.
...
def main():
    ...
    logger.info("="*60)
    logger.info(f"SSL Training with {config.ssl.algorithm}")
    logger.info("="*60)
    ...
    # Create trainer based on configured SSL algorithm
